        ...
        <div class="col-md-6">
            ...
            <div class="card">
                <div class="card-header">
                  <h4>Edit Store with name:  <span class="text-info">{{ $store->name }}</span></h4>
                </div>
                <div class="card-body">
                    @csrf
                  ...
                  <div class="form-group">
                    <label>Address</label>
                    <textarea name="address" cols="30" rows="30" class="form-control  {{ $errors->has('address') ? ' is-invalid' : '' }}">{{ $store->address }}</textarea>
                    <small class="text-danger">{{ $errors->first('address') }}</small>
                  </div>
                  <div class="form-group">
                      <button type="submit" class="btn btn-info"> <i class="fa fa-save"></i> Update Store</button>
                  </div>
              </div>
        </div>    
    </form>
