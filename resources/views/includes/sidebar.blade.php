      ...
      <ul class="sidebar-menu">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="nav-link" href="layout-default.html">Tambah Product</a></li>
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
            <li><a class="nav-link" href="layout-default.html">Tambah Store</a></li>
            <li><a class="nav-link" href="layout-transparent.html">Daftar Store</a></li>
            </ul>
        </li>
